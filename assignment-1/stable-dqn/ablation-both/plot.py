...
# Load CSV file
csv_path = "ablation_both_results.csv"
...
for config in configurations:
    ...
    downsample_factor = 100  # Plot every 100th episode
...
plt.title("Ablation Study: TN & ER on DQN Performance")
plt.legend()
plt.grid()

# Save and show the plot
plot_path = "ablation_both_plot.png"
